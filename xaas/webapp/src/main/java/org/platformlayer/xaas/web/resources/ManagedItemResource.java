...
public class ManagedItemResource extends XaasResourceBase {
    ...
    @Consumes({ XML })
    @Produces({ XML, JSON })
    public <T extends ItemBase> T createItem(final T item, @QueryParam("unique") String uniqueTag) throws RepositoryException, OpsException {
    ...
    @Consumes({ JSON })
    @Produces({ XML, JSON })
    public <T extends ItemBase> T createItemJson(String json, @QueryParam("unique") String uniqueTag) throws RepositoryException, OpsException, JAXBException, XMLStreamException {
