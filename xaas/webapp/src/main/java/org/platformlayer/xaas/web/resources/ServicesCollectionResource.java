...
public class ServicesCollectionResource extends XaasResourceBase {
    ...
    public ServiceAuthorizationCollectionResource getServiceAuthorizationsResource() {
        ServiceAuthorizationCollectionResource child = objectInjector.getInstance(ServiceAuthorizationCollectionResource.class);
        return child;
    }
    ...
    // @GET
    // @Produces({ APPLICATION_XML, APPLICATION_JSON })
    // public ManagedItemCollection<?> listServices(@QueryParam("namespace") String namespace, @QueryParam("element") String nodeName) throws RepositoryException {
