...
public class JdbcJobRepository implements JobRepository {
    ...
    @Override
    @JdbcTransaction
    public void recordJob(PlatformLayerKey jobId, PlatformLayerKey itemKey, JobState jobState, JobLog jobLog) throws RepositoryException {
        ...
        try {
            ...
            int updateCount = db.insertJobLog(itemKey.getServiceType(), itemKey.getItemType(), itemKey.getProject(), itemKey.getItemId(), jobState, data);
    ...
    static interface Queries {
        ...
        int insertJobLog(int service, int model, int project, String key, int jobState, String data) throws SQLException;
    }
    ...
    class DbHelper extends DbHelperBase {
        ...
        public int insertJobLog(ServiceType serviceType, ItemType itemType, ProjectId project, ManagedItemId itemId, JobState jobState, String data) throws SQLException {
            return queries.insertJobLog(mapToValue(serviceType), mapToValue(itemType), mapToValue(project), itemId.getKey(), jobState.getCode(), data);
        }
    }
}
