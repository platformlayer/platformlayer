...
public class DirectImageStore implements ImageStore {
    ...
    @Override
    public String uploadImage(final OpsTarget srcImageHost, Tags tags, final File srcImageFile, long rawImageFileSize) throws OpsException {
            ...
            for (int attempt = 1; attempt <= maxAttempts; attempt++) {
                ...
                Callable<ProcessExecution> serveFile = new Callable<ProcessExecution>() {
                    ...
                    public ProcessExecution call() throws Exception {
                        ...
                        Command sendCommand = Command.build("socat -u OPEN:{0},rdonly TCP4-LISTEN:{1}", srcImageFile, port, targetAddress.getHostAddress() + "/32");
                ...
                for (int readAttempts = 1; readAttempts <= 10; readAttempts++) {
                    ...
                    Command receiveCommand = Command.build("socat -u TCP4:{0} CREATE:{1}", srcAddress.getHostAddress() + ":" + port, targetImageFile);
                    try {
