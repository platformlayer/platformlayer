...
//
//	public SimpleUserInfo(OpsAuthentication auth, OpsConfig config) {
//		this.auth = auth;
//		this.config = config;
//		// super();
...
//
//			FederationMap federationMap = FederatedPlatformLayerClient.buildFederationMap(typedLocalClient, mapper);
//
//			platformLayerClient = FederatedPlatformLayerClient.build(federationMap);
//		}
