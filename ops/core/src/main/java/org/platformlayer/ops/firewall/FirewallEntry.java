...
public class FirewallEntry {
    ...
    // * @return
    // */
    // public static List<FirewallEntry> buildInternalNetworkRule(OpsItem item, int localPort, Protocol protocol, String[] ec2Groups) {
    ...
    // } else {
    // List<FirewallEntry> entries = buildBidirectionalLocalPort(opsSystem, localPort, protocol, FirewallNetmask.LocalPrivateNetwork);
    // return entries;
    // }
    // }
    //
    ...
    // }
    //
    // private static List<FirewallEntry> buildBidirectionalLocalPort(OpsSystem opsSystem, int localPort, Protocol protocol, FirewallNetmask remoteNetmask) {
    // if (localPort == 0)
    // throw new IllegalStateException();
    //
    // List<FirewallEntry> entries = Lists.newArrayList();
    //
    // entries.add(FirewallEntry.build(opsSystem, FirewallRecord.buildPassQuickLocalPort(Direction.In, localPort, protocol, remoteNetmask)));
    // entries.add(FirewallEntry.build(opsSystem, FirewallRecord.buildPassQuickLocalPort(Direction.Out, localPort, protocol, remoteNetmask)));
    //
    // return entries;
    // }
    //
    // private static List<FirewallEntry> buildBidirectionalLocalPort(OpsSystem opsSystem, int localPort, Protocol protocol, String[] ec2Groups) {
    // if (localPort == 0)
    // throw new IllegalStateException();
    //
    ...
    // continue;
    //
    // entries.add(FirewallEntry.build(opsSystem, FirewallRecord.buildPassQuickLocalPort(Direction.In, localPort, protocol, FirewallNetmask.buildAwsIdentifierFathomDB(ec2Group))));
    // entries.add(FirewallEntry.build(opsSystem, FirewallRecord.buildPassQuickLocalPort(Direction.Out, localPort, protocol, FirewallNetmask.buildAwsIdentifierFathomDB(ec2Group))));
    // }
    //
    // if (entries.size() == 0)
    ...
    // }
    //
    // private static List<FirewallEntry> buildBidirectionalRemotePort(OpsSystem opsSystem, int remotePort, Protocol protocol, FirewallNetmask remoteNetmask) {
    // if (remotePort == 0)
    // throw new IllegalStateException();
    //
    // List<FirewallEntry> entries = Lists.newArrayList();
    //
    // entries.add(FirewallEntry.build(opsSystem, FirewallRecord.buildPassQuickRemotePort(Direction.In, remotePort, protocol, remoteNetmask)));
    // entries.add(FirewallEntry.build(opsSystem, FirewallRecord.buildPassQuickRemotePort(Direction.Out, remotePort, protocol, remoteNetmask)));
    //
    // return entries;
    // }
    //
    // public static List<FirewallEntry> buildAwsAccessLocalPort(OpsSystem opsSystem, String awsIdentifier, int port, Protocol protocol) {
    ...
    // * @return
    // */
    // public static List<FirewallEntry> buildBidirectionalLocalPort(OpsSystem opsSystem, String cidr, int port, Protocol protocol) {
    ...
    // * @return
    // */
    // public static List<FirewallEntry> buildBidirectionalRemotePort(OpsSystem opsSystem, String remoteCidr, int port, Protocol protocol) {
    // return buildBidirectionalRemotePort(opsSystem, port, protocol, FirewallNetmask.buildCidr(remoteCidr));
    // }
    //
    // @SupportsStandardOperations({ StandardOperation.Configure, StandardOperation.Validate, StandardOperation.Initialize })
