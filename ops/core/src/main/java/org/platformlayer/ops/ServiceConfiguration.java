...
public class ServiceConfiguration {
    ...
    public ServiceConfiguration(ServiceAuthorizationService serviceAuthorizationService, ServiceType serviceType, ProjectId project) {
    ...
    private KeyPair findKeyPair(ServiceType serviceType, ProjectId projectId, ServiceMetadataKey keyId) throws OpsException {
        String keyData;
        try {
    ...
    private void storeKeyPair(ServiceType serviceType, ProjectId project, ServiceMetadataKey keyId, KeyPair keyPair) throws OpsException {
        String serialized;
        try {
