...
public class FirewallNetmask {
	...
	public FirewallNetmask deepCopy() {
		FirewallNetmask clone = new FirewallNetmask(this.netmaskType, this.cidr, this.awsSecurityGroup,
				this.awsIdentifier);
	...
	public static final FirewallNetmask LocalPrivateNetwork = new FirewallNetmask(NetmaskType.LocalPrivateNetwork,
			null, null, null);
