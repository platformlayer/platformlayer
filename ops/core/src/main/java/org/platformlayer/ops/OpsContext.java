...
public class OpsContext implements Closeable {
    ...
    public OpsContext(OpsSystem opsSystem, JobRecord jobRecord, UserInfo userInfo, ServiceConfiguration serviceConfiguration) {
        super();
        this.opsSystem = opsSystem;
        this.jobRecord = jobRecord;
        this.userInfo = userInfo;
        this.serviceConfiguration = serviceConfiguration;
        this.jobLogger = new JobLogger(jobRecord.log);
    }
