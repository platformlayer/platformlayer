...
public class MinaScpClient {
    ...
    public void put(InputStream sourceData, long sourceDataLength, String remoteFileName, String remoteDirectory, String mode, TimeSpan timeout) throws IOException, SshException {
        String cmd;
    ...
    private void receiveFile(PipedOutputStream stdin, InputStream channelInputStream, OutputStream destOutputStream) throws IOException, SshException {
    ...
    private void sendFile(PipedOutputStream stdin, InputStream channelInputStream, InputStream srcData, long srcDataLength, String mode, String remoteFileName) throws IOException, SshException {
