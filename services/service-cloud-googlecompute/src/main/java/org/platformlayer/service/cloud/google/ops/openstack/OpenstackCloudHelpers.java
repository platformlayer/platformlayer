...
public class OpenstackCloudHelpers {
	...
	public OpenstackComputeClient buildOpenstackComputeClient(GoogleCloud cloud) throws OpsException {
		try {
	...
	public OpenstackImageClient buildOpenstackImageClient(GoogleCloud cloud) throws OpsException {
		try {
			OpenstackSession session = buildOpenstackSession(cloud);
	...
	private OpenstackSession buildOpenstackSession(GoogleCloud cloud) throws OpsException {
	...
	public List<Ip> findPublicIps(GoogleCloud cloud, Server server) {
