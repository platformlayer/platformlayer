...
public class OpenstackCloudContext {
	...
	public OpenstackComputeClient getComputeClient(GoogleCloud cloud) throws OpsException {
		// OpsContext opsContext = OpsContext.get();
		//
	...
	public Server findServerById(GoogleCloud cloud, String serverId) throws OpsException {
	...
	public Server createInstance(GoogleCloud cloud, String serverName, MachineCreationRequest request)
			throws OpsException {
		OpenstackComputeClient computeClient = getComputeClient(cloud);
	...
	public AsyncServerOperation terminateInstance(GoogleCloud cloud, String instanceId) throws OpsException {
		try {
			OpenstackComputeClient computeClient = getComputeClient(cloud);
	...
	public ImageStore getImageStore(GoogleCloud cloud) throws OpsException {
		OpenstackCloudHelpers helpers = new OpenstackCloudHelpers();
	...
	public Server ensureHasPublicIp(final GoogleCloud cloud, Server server) throws OpsException {
	...
	public AsyncServerOperation ensurePoweredOn(GoogleCloud cloud, Server server) throws OpsException {
