...
public class JaxbHelper {
    ...
    static ConcurrentMap<Class<?>, JaxbHelper> jaxbHelpers = new MapMaker().makeComputingMap(new Function<Class<?>, JaxbHelper>() {
    ...
    public static <T> T deserializeXmlObject(InputStream is, Class<T> clazz, boolean recordXml) throws UnmarshalException {
        return deserializeXmlObject(Utf8.openReader(is), clazz, recordXml);
    }

    public static <T> T deserializeXmlObject(Reader reader, Class<T> clazz, boolean recordXml) throws UnmarshalException {
    ...
    public <T> T deserialize(Reader reader, Class<T> clazz, boolean recordXml) throws UnmarshalException {
        ...
        if (value == null) {
            throw new UnmarshalException("Expected response to be of type: " + clazz.getSimpleName() + ", was " + jaxbObject.getClass().getSimpleName(), null, xml);
        }
        return value;
    }
