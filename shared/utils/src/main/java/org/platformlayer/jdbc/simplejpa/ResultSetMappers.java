...
public class ResultSetMappers {
    ...
    final ConcurrentMap<Class<?>, Relationships> relationshipsByClass = new MapMaker().makeComputingMap(new Function<Class<?>, Relationships>() {
        @Override
    ...
    public void populateInternalRelationships(JoinedQueryResult mapResult) throws SecurityException, NoSuchFieldException, IllegalArgumentException, IllegalAccessException {
