...
public class Relationships {
	...
	static class OneToManyRelationship {
		...
		public OneToManyRelationship(Class<?> thisClass, Field thisField, Class<?> manyClass, Field manyField,
		...
		try {
			for (Field thisField : thisClass.getFields()) {
				...
				if (oneToManyAnnotation != null) {
					...
					oneToManyRelationships.add(new OneToManyRelationship(thisClass, thisField, manyClass, manyField,
							comparator));
				}
				...
				if (manyToOneAnnotation != null) {
					...
					manyToOneRelationships.add(new ManyToOneRelationship(thisClass, thisField, foreignType,
							foreignKeyField));
				}
			}
