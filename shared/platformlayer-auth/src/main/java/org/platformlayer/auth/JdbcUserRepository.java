...
public class JdbcUserRepository implements UserRepository {
    ...
    @Override
    @JdbcTransaction
    public void addUserToProject(String username, String projectKey, SecretKey projectSecret) throws RepositoryException {
    ...
    static interface Queries {
        ...
        int insertProject(String key, byte[] secretData, byte[] metadata, byte[] publicKey, byte[] privateKey) throws SQLException;;
    ...
    class DbHelper extends DbHelperBase {
        ...
        public int insertUser(String userName, byte[] hashedPassword, byte[] secretData, byte[] publicKeyData, byte[] privateKeyData) throws SQLException {
            Integer userId = null;
        ...
        public int createProject(String key, byte[] secretData, byte[] metadata, byte[] publicKeyData, byte[] privateKeyData) throws SQLException {
