...
public class FederatedPlatformLayerClient extends PlatformLayerClientBase {
    ...
    public static FederatedPlatformLayerClient buildUsingConfig(InputStream is, TypedItemMapper mapper) throws OpsException {
        FederationConfiguration federationMapConfig = SmartDeserialization.deserialize(FederationConfiguration.class, is);
    ...
    private <V> Iterable<V> doListConcatenation(Iterable<ChildClient> childClients, HostFunction<Iterable<V>> function) throws PlatformLayerClientException {
        try {
    ...
    public static PlatformLayerClient build(TypedPlatformLayerClient localClient, TypedItemMapper mapper) throws OpsException {
