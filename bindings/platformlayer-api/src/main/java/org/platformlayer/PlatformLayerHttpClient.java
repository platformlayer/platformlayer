...
class PlatformLayerHttpClient {
    ...
    protected <T> T doSimpleRequest(String relativePath, Class<T> retvalClass, Format format) throws PlatformLayerClientException {
    ...
    protected <T> T doRequest(String method, String relativePath, Class<T> retvalClass, Format acceptFormat, Object sendData, Format sendDataFormat) throws PlatformLayerClientException {
        int maxRetries = 1;
