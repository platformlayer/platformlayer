...
public class ListConcatentation<T> extends ToIterable<Iterable<T>> {
    ...
    public static <K, T, E extends Exception> Iterable<T> joinLists(ForkJoinStrategy forkJoinPool, Iterable<K> keys, final CheckedFunction<K, Iterable<T>, E> map) throws ExecutionException {
