...
//
//	// /**
//	// * A regular expression used by the {@link #markup(Element, String, String)} function to search for http links and
//	// * new lines.
//	// */
//	// private static final RegExp REGEXP_MARKUP = RegExp.compile("(?:(?:(?:https?://)|(?:www\\.))[^\\s]+)|[\n]", "ig");
//
//	@SuppressWarnings("unchecked")
//	public static <T extends com.google.gwt.dom.client.Element, R extends Element> R asJsElement(T element) {
...
//	// * @param with
//	// * The element that we will attach to the element that we just erased the contents of.
//	// */
...
//	//
//	// /**
//	// * Scans a string converting any recognizable html links into an anchor tag and replacing newlines with a
//	// * &lt;br/&gt;. Once built the result is appended to the provided element.
//	// */
...
//	//
//	// /*
//	// * If our match is a \n we need to create a <br/> element to force a line break, otherwise we matched an
//	// * http/www link so let's make an anchor tag out of it.
//	// */
