...
//
//import org.platformlayer.ui.web.client.widgets.ServiceInfoEditor;
...
//
///**
// * This class shows how the UI for editing a person is wired up to the RequestFactoryEditorDelegate. It is also responsible for showing and dismissing the PersonEditor. The use of the FavoriteManager
// * shows integration between a remote service and a local service.
// */
...
//    }
//
//    interface Driver extends RequestFactoryEditorDriver<ServiceInfoProxy, ServiceInfoEditor> {
//    }
//
//    static void register(EventBus eventBus, final PlatformLayerRequestFactory requestFactory/* , final FavoritesManager manager */) {
...
//    ServiceInfoEditor serviceInfoEditor;
//
//    private Driver editorDriver;
//    // private final FavoritesManager manager;
//    private ServiceInfoProxy person;
//    private final PlatformLayerRequestFactory requestFactory;
//
//    private PersonEditorWorkflow(PlatformLayerRequestFactory requestFactory/* , FavoritesManager manager */, ServiceInfoProxy person) {
...
//        serviceInfoEditor = new ServiceInfoEditor(/* mentorEditor, scheduleEditor */);
...
//
//    /**
//     * Called by the cancel button when it is clicked. This method will just tear down the UI and clear the state of the workflow.
//     */
//    @UiHandler("cancel")
...
//
//    /**
//     * Called by the edit dialog's save button. This method will flush the contents of the UI into the PersonProxy that is being edited, check for errors, and send the request to the server.
//     */
//    @UiHandler("save")
...
//        editorDriver.initialize(requestFactory, serviceInfoEditor);
//
...
//        Request<ServiceInfoProxy> fetchRequest = requestFactory.find(person.stableId());
//
...
//        fetchRequest.to(new Receiver<ServiceInfoProxy>() {
//            @Override
