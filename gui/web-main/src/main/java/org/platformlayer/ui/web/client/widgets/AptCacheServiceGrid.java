...
//
//import org.platformlayer.ui.web.client.events.EditAptCacheServiceEvent;
...
//import org.platformlayer.ui.web.shared.PlatformLayerRequestFactory.AptCacheServiceRequest;
//
...
//
//        EntityProxyChange.registerForProxyType(eventBus, AptCacheServiceProxy.class, new EntityProxyChange.Handler<AptCacheServiceProxy>() {
//            @Override
...
//        lastFetch = start;
//        requestFactory.aptCacheRequest().findAll(/* start, numRows, filter */).fire(new Receiver<List<AptCacheServiceProxy>>() {
//            @Override
